...
\usepackage{soul}
\usepackage{listings}
\usepackage{xcolor} % Required if you want to add colors
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{img/er-logico.png}
...
\begin{itemize}
    ...
    \item Un trigger di tipo \texttt{BEFORE UPDATE} avrebbe verificato che se fosse stato modificato il corso della lezione, il nuovo corso appartenga allo stesso corso di laurea di quello precedente, mentre se la modifica faccia riferimento all'aula, sarebbe stata verificata che l'istanza dell'edificio, relativa all'edificio in cui verrà svolta la lezione, identifichi, nel vincolo inter-relazionale, il medesimo corso di laurea del corso della lezione.
